      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 sm:px-6">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a
              href="https://www.facebook.com/askhan1497" target="_blank"
              className="hover:text-white transition-colors duration-300"
            >
              Facebook
            </a>
            <a
              href="mailto:akay41024@gmail.com" target="_blank"
              className="hover:text-white transition-colors duration-300"
            >
              Email
            </a>
            <a
              href="https://www.instagram.com/askhan1497/" target="_blank"
              className="hover:text-white transition-colors duration-300"
            >
              Instagram
            </a>
